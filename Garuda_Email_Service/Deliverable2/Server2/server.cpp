...
{
    ServerIP.insert(pair<string,string>("xyz.com","127.0.0.1"));
    ServerIP.insert(pair<string,string>("abc.com",IP));

    ServerPort.insert(pair<string,int>("xyz.com",5025));
    ServerPort.insert(pair<string,int>("abc.com",atoi(port)));
}
